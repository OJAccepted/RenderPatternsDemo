...
function gc(a,b,c){if(25<=Zb)throw Error("Too many re-renders. React limits the number of renders to prevent an infinite loop.");if(a===M)if(Yb=!0,a={action:c,next:null},null===T&&(T=new Map),c=T.get(b),void 0===c)T.set(b,a);else{for(b=c;null!==b.next;)b=b.next;b.next=a}}function ic(){throw Error("A function wrapped in useEffectEvent can't be called during rendering.");}function jc(){throw Error("startTransition cannot be called during server rendering.");}
...
if(null===d)throw Error("An ID must have been assigned before we can complete the boundary.");e=e.toString(16);l(b,d);l(b,'","');l(b,a.segmentPrefix);l(b,e);f?(l(b,'",'),bb(b,c)):l(b,'"');b=!!b.write(")\x3c/script>");return b}
...
l(b,a.segmentPrefix);e=e.toString(16);l(b,e);l(b,'","');l(b,a.placeholderPrefix);l(b,e);b=!!b.write('")\x3c/script>');return b}
...
exports.renderToStaticNodeStream=function(){throw Error("ReactDOMServer.renderToStaticNodeStream(): The Node Stream API is not available in Bun. Use ReactDOMServer.renderToReadableStream() instead.");};exports.version="18.3.0-experimental-758fc7fde-20230207";
